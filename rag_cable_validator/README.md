...
├── prompt.py            # Validation prompt
├── qwen_llm.py          # Qwen model loader & inference
├── embedder.py          # SentenceTransformer embeddings
├── faiss_store.py       # FAISS index save/load
...
```json
{
  ...
  "source": "IEC 60502-1 Table 5 – PVC insulation thickness for 16 sqmm at 0.6/1 kV"
}
```
